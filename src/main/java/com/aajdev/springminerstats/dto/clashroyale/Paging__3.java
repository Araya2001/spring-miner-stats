...
public class Paging__3 {

    @JsonProperty("cursors")
    private Cursors__3 cursors;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("cursors")
    public Cursors__3 getCursors() {
        return cursors;
    }

    @JsonProperty("cursors")
    public void setCursors(Cursors__3 cursors) {
    ...
    public String toString() {
        ...
        sb.append(Paging__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("cursors");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Paging__3) == false) {
            return false;
        }
        Paging__3 rhs = ((Paging__3) other);
