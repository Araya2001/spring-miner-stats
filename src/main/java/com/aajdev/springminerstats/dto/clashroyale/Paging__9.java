...
public class Paging__9 {

    @JsonProperty("cursors")
    private Cursors__9 cursors;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("cursors")
    public Cursors__9 getCursors() {
        return cursors;
    }

    @JsonProperty("cursors")
    public void setCursors(Cursors__9 cursors) {
    ...
    public String toString() {
        ...
        sb.append(Paging__9 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("cursors");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Paging__9) == false) {
            return false;
        }
        Paging__9 rhs = ((Paging__9) other);
