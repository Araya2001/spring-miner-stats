...
public class IconUrls__4 {
    ...
    public String toString() {
        ...
        sb.append(IconUrls__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("medium");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IconUrls__4) == false) {
            return false;
        }
        IconUrls__4 rhs = ((IconUrls__4) other);
