...
public class CurrentFavouriteCard {
    ...
    @JsonProperty("iconUrls")
    public IconUrls__5 getIconUrls() {
        return iconUrls;
    }

    @JsonProperty("iconUrls")
    public void setIconUrls(IconUrls__5 iconUrls) {
    ...
    public String toString() {
        ...
        sb.append(CurrentFavouriteCard.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CurrentFavouriteCard) == false) {
            return false;
        }
        CurrentFavouriteCard rhs = ((CurrentFavouriteCard) other);
