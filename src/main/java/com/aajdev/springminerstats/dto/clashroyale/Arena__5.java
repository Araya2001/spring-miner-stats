...
public class Arena__5 {
    ...
    public String toString() {
        ...
        sb.append(Arena__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Arena__5) == false) {
            return false;
        }
        Arena__5 rhs = ((Arena__5) other);
