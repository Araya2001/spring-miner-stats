...
public class Clan__8 {
    ...
    public String toString() {
        ...
        sb.append(Clan__8 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tag");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Clan__8) == false) {
            return false;
        }
        Clan__8 rhs = ((Clan__8) other);
