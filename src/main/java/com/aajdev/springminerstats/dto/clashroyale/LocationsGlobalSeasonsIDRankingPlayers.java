...
public class LocationsGlobalSeasonsIDRankingPlayers {

    @JsonProperty("items")
    private List<Item__4> items = new ArrayList<Item__4>();
    @JsonProperty("paging")
    private Paging__3 paging;
    @JsonIgnore
    ...
    @JsonProperty("paging")
    public Paging__3 getPaging() {
        return paging;
    }

    @JsonProperty("paging")
    public void setPaging(Paging__3 paging) {
        this.paging = paging;
    }
    ...
    public String toString() {
        ...
        sb.append(LocationsGlobalSeasonsIDRankingPlayers.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("items");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LocationsGlobalSeasonsIDRankingPlayers) == false) {
            return false;
        }
        LocationsGlobalSeasonsIDRankingPlayers rhs = ((LocationsGlobalSeasonsIDRankingPlayers) other);
