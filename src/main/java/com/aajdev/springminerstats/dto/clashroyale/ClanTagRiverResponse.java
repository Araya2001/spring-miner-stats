...
public class ClanTagRiverResponse {

    @JsonProperty("items")
    private List<Item__3> items = new ArrayList<Item__3>();
    @JsonProperty("paging")
    private Paging__2 paging;
    @JsonIgnore
    ...
    @JsonProperty("paging")
    public Paging__2 getPaging() {
        return paging;
    }

    @JsonProperty("paging")
    public void setPaging(Paging__2 paging) {
        this.paging = paging;
    }
    ...
    public String toString() {
        ...
        sb.append(ClanTagRiverResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("items");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ClanTagRiverResponse) == false) {
            return false;
        }
        ClanTagRiverResponse rhs = ((ClanTagRiverResponse) other);
