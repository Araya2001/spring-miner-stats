...
public class TournamentNameResponse {
    ...
    @JsonProperty("items")
    private List<Item__11> items = new ArrayList<Item__11>();
    @JsonProperty("paging")
    private Paging__9 paging;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("items")
    public List<Item__11> getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(List<Item__11> items) {
        this.items = items;
    }

    @JsonProperty("paging")
    public Paging__9 getPaging() {
        return paging;
    }

    @JsonProperty("paging")
    public void setPaging(Paging__9 paging) {
        this.paging = paging;
    }
