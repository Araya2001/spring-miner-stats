...
public class GameMode {
    ...
    public String toString() {
        ...
        sb.append(GameMode.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GameMode) == false) {
            return false;
        }
        GameMode rhs = ((GameMode) other);
