...
public class Participant__1 {
    ...
    public String toString() {
        ...
        sb.append(Participant__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tag");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Participant__1) == false) {
            return false;
        }
        Participant__1 rhs = ((Participant__1) other);
