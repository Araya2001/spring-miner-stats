...
public class Arena__1 {
    ...
    public String toString() {
        ...
        sb.append(Arena__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Arena__1) == false) {
            return false;
        }
        Arena__1 rhs = ((Arena__1) other);
