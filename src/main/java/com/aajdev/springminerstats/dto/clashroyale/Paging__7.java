...
public class Paging__7 {

    @JsonProperty("cursors")
    private Cursors__7 cursors;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("cursors")
    public Cursors__7 getCursors() {
        return cursors;
    }

    @JsonProperty("cursors")
    public void setCursors(Cursors__7 cursors) {
    ...
    public String toString() {
        ...
        sb.append(Paging__7 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("cursors");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Paging__7) == false) {
            return false;
        }
        Paging__7 rhs = ((Paging__7) other);
