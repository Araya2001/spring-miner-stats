...
public class Clan__4 {
    ...
    public String toString() {
        ...
        sb.append(Clan__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tag");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Clan__4) == false) {
            return false;
        }
        Clan__4 rhs = ((Clan__4) other);
