...
public class LocationsResponse {
    ...
    @JsonProperty("items")
    private List<Item__9> items = new ArrayList<Item__9>();
    @JsonProperty("paging")
    private Paging__8 paging;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("items")
    public List<Item__9> getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(List<Item__9> items) {
        this.items = items;
    }

    @JsonProperty("paging")
    public Paging__8 getPaging() {
        return paging;
    }

    @JsonProperty("paging")
    public void setPaging(Paging__8 paging) {
        this.paging = paging;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LocationsResponse) == false) {
            return false;
        }
