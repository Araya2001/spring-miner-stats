...
public class Clan__5 {
    ...
    public String toString() {
        ...
        sb.append(Clan__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tag");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Clan__5) == false) {
            return false;
        }
        Clan__5 rhs = ((Clan__5) other);
