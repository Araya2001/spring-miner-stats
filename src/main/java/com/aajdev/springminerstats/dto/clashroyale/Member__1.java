...
public class Member__1 {
    ...
    @JsonProperty("arena")
    public Arena__2 getArena() {
        return arena;
    }

    @JsonProperty("arena")
    public void setArena(Arena__2 arena) {
        this.arena = arena;
    }
    ...
    public String toString() {
        ...
        sb.append(Member__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tag");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Member__1) == false) {
            return false;
        }
        Member__1 rhs = ((Member__1) other);
