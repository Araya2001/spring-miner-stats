...
public class Paging__6 {

    @JsonProperty("cursors")
    private Cursors__6 cursors;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("cursors")
    public Cursors__6 getCursors() {
        return cursors;
    }

    @JsonProperty("cursors")
    public void setCursors(Cursors__6 cursors) {
    ...
    public String toString() {
        ...
        sb.append(Paging__6 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("cursors");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Paging__6) == false) {
            return false;
        }
        Paging__6 rhs = ((Paging__6) other);
