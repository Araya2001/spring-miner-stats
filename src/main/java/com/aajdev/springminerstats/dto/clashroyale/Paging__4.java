...
public class Paging__4 {

    @JsonProperty("cursors")
    private Cursors__4 cursors;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("cursors")
    public Cursors__4 getCursors() {
        return cursors;
    }

    @JsonProperty("cursors")
    public void setCursors(Cursors__4 cursors) {
    ...
    public String toString() {
        ...
        sb.append(Paging__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("cursors");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Paging__4) == false) {
            return false;
        }
        Paging__4 rhs = ((Paging__4) other);
