...
public class Clan__6 {
    ...
    public String toString() {
        ...
        sb.append(Clan__6 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tag");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Clan__6) == false) {
            return false;
        }
        Clan__6 rhs = ((Clan__6) other);
