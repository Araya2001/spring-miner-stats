...
public class Arena__3 {
    ...
    public String toString() {
        ...
        sb.append(Arena__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Arena__3) == false) {
            return false;
        }
        Arena__3 rhs = ((Arena__3) other);
