...
public class Clan__2 {
    ...
    private List<Participant__2> participants = new ArrayList<Participant__2>();
    ...
    @JsonProperty("participants")
    public List<Participant__2> getParticipants() {
        return participants;
    }

    @JsonProperty("participants")
    public void setParticipants(List<Participant__2> participants) {
    ...
    public String toString() {
        ...
        sb.append(Clan__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tag");
        sb.append('=');
