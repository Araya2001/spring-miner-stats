...
public class ClanTag {
    ...
    public String toString() {
        ...
        sb.append(ClanTag.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tag");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ClanTag) == false) {
            return false;
        }
        ClanTag rhs = ((ClanTag) other);
