...
public class Arena__4 {
    ...
    public String toString() {
        ...
        sb.append(Arena__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Arena__4) == false) {
            return false;
        }
        Arena__4 rhs = ((Arena__4) other);
