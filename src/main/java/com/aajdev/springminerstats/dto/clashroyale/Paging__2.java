...
public class Paging__2 {

    @JsonProperty("cursors")
    private Cursors__2 cursors;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("cursors")
    public Cursors__2 getCursors() {
        return cursors;
    }

    @JsonProperty("cursors")
    public void setCursors(Cursors__2 cursors) {
    ...
    public String toString() {
        ...
        sb.append(Paging__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("cursors");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Paging__2) == false) {
            return false;
        }
        Paging__2 rhs = ((Paging__2) other);
