...
public class Paging__8 {

    @JsonProperty("cursors")
    private Cursors__8 cursors;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("cursors")
    public Cursors__8 getCursors() {
        return cursors;
    }

    @JsonProperty("cursors")
    public void setCursors(Cursors__8 cursors) {
    ...
    public String toString() {
        ...
        sb.append(Paging__8 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("cursors");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Paging__8) == false) {
            return false;
        }
        Paging__8 rhs = ((Paging__8) other);
