...
public class IconUrls__3 {
    ...
    public String toString() {
        ...
        sb.append(IconUrls__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("medium");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IconUrls__3) == false) {
            return false;
        }
        IconUrls__3 rhs = ((IconUrls__3) other);
