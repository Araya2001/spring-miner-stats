...
public class IconUrls__5 {
    ...
    public String toString() {
        ...
        sb.append(IconUrls__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("medium");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IconUrls__5) == false) {
            return false;
        }
        IconUrls__5 rhs = ((IconUrls__5) other);
