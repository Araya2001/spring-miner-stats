...
public class Arena__2 {
    ...
    public String toString() {
        ...
        sb.append(Arena__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Arena__2) == false) {
            return false;
        }
        Arena__2 rhs = ((Arena__2) other);
