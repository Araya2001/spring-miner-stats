...
public class Item__5 {
    ...
    public String toString() {
        ...
        sb.append(Item__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Item__5) == false) {
            return false;
        }
        Item__5 rhs = ((Item__5) other);
