...
public class Paging__5 {

    @JsonProperty("cursors")
    private Cursors__5 cursors;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("cursors")
    public Cursors__5 getCursors() {
        return cursors;
    }

    @JsonProperty("cursors")
    public void setCursors(Cursors__5 cursors) {
    ...
    public String toString() {
        ...
        sb.append(Paging__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("cursors");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Paging__5) == false) {
            return false;
        }
        Paging__5 rhs = ((Paging__5) other);
