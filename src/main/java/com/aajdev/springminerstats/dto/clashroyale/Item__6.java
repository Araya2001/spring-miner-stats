...
public class Item__6 {
    ...
    public String toString() {
        ...
        sb.append(Item__6 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tag");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Item__6) == false) {
            return false;
        }
        Item__6 rhs = ((Item__6) other);
