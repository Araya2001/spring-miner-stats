...
public class LocationsGlobalSeasonsQuery {

    @JsonProperty("items")
    private List<Item__5> items = new ArrayList<Item__5>();
    @JsonProperty("paging")
    private Paging__4 paging;
    @JsonIgnore
    ...
    @JsonProperty("paging")
    public Paging__4 getPaging() {
        return paging;
    }

    @JsonProperty("paging")
    public void setPaging(Paging__4 paging) {
        this.paging = paging;
    }
    ...
    public String toString() {
        ...
        sb.append(LocationsGlobalSeasonsQuery.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("items");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LocationsGlobalSeasonsQuery) == false) {
            return false;
        }
        LocationsGlobalSeasonsQuery rhs = ((LocationsGlobalSeasonsQuery) other);
