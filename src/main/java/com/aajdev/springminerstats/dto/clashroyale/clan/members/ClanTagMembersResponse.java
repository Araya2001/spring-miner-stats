package com.aajdev.springminerstats.dto.clashroyale.clan.members;
...
public class ClanTagMembersResponse {
    ...
    public String toString() {
        ...
        sb.append(ClanTagMembersResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("items");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ClanTagMembersResponse) == false) {
            return false;
        }
        ClanTagMembersResponse rhs = ((ClanTagMembersResponse) other);
