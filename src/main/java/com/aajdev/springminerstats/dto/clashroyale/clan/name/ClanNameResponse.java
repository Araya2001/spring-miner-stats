...
public class ClanNameResponse {
    ...
    public String toString() {
        ...
        sb.append(ClanNameResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("items");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ClanNameResponse) == false) {
            return false;
        }
        ClanNameResponse rhs = ((ClanNameResponse) other);
