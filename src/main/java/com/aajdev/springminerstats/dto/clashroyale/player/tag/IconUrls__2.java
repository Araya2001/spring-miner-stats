...
public class IconUrls__2 {
    ...
    public String toString() {
        ...
        sb.append(IconUrls__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("medium");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IconUrls__2) == false) {
            return false;
        }
        IconUrls__2 rhs = ((IconUrls__2) other);
