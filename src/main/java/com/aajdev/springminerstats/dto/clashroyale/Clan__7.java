...
public class Clan__7 {
    ...
    public String toString() {
        ...
        sb.append(Clan__7 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tag");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Clan__7) == false) {
            return false;
        }
        Clan__7 rhs = ((Clan__7) other);
